<%@ page language="java" import="con.paperless.testing.*" contentType="text/html; charset=ISO-8859-1"
...
<title>Test</title>
 <style type="text/css">
body {
	background: url("${pageContext.request.contextPath}/images/onlinetestingsystembg.jpg");
}
</style>
...
<%
  int currentQuestion=((Test)request.getSession().getAttribute("currentExam")).getCurrentQuestion();

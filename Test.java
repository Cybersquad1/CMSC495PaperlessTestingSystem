...
import con.paperless.testing.LoginDOM;
...
public class Test {
	...
	public ArrayList<TestQuestions> questionList = new ArrayList<TestQuestions>(10);
	
	public Test(String test) throws SAXException,ParserConfigurationException,IOException, URISyntaxException{
		dom=LoginDOM.getDOM(test);
	}
	...
	{   int number=i;
		...
		t.setQuestionNumber(number);
		t.setQuestion(question);
		t.setCorrectOptionIndex(correct);
		t.setQuestionOptions(options);
		questionList.add(number,t);
		
	}
	
	
	public ArrayList<TestQuestions> getQuestionList(){
	...
	public int calculateResult(Test exam){
		int totalCorrect=0;
		...
		List<TestQuestions> questionList=exam.questionList;
